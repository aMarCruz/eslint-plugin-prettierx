 ...
 * @returns {void}
 */
const reportInsert = function reportInsert (context, offset, text) {
  const end = offset
 ...
 * @returns {void}
 */
const reportDelete = function reportDelete (context, offset, text) {
 ...
 * @returns {void}
 */
const reportReplace = function reportReplace (context, offset, deleteText, insertText) {
 ...
 */
const reportDiffs = function (context, source, prettierSource) {
